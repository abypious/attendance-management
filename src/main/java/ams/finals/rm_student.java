 ...
 * @author abypi
 */
public class rm_student extends javax.swing.JFrame {

    /**
     * Creates new form rm_student
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("STUDENT KTU ID");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql= "delete from slogin where userid=?";
        String sql1= "delete from student_list where ktu_id=?";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rm_student.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rm_student().setVisible(true);
            }
        });
    }
